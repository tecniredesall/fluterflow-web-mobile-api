...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    ctrbackupAuthUserSubject.add(
      CtrbackupAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<CtrbackupAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  CtrbackupAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = CtrbackupAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    ctrbackupAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
