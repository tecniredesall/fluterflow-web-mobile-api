...
class CtrInventoryStruct extends BaseStruct {
  CtrInventoryStruct({
    double? total,
    double? open,
    double? fixed,
  ...
  static CtrInventoryStruct fromMap(Map<String, dynamic> data) =>
      CtrInventoryStruct(
  ...
  static CtrInventoryStruct? maybeFromMap(dynamic data) => data is Map
      ? CtrInventoryStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static CtrInventoryStruct fromSerializableMap(Map<String, dynamic> data) =>
      CtrInventoryStruct(
  ...
  @override
  String toString() => 'CtrInventoryStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is CtrInventoryStruct &&
        total == other.total &&
        open == other.open &&
        fixed == other.fixed &&
...
CtrInventoryStruct createCtrInventoryStruct({
  double? total,
  double? open,
  double? fixed,
  double? unsettled,
