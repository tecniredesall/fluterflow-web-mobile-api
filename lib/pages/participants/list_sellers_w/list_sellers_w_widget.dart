...
import 'list_sellers_w_model.dart';
export 'list_sellers_w_model.dart';

class ListSellersWWidget extends StatefulWidget {
  const ListSellersWWidget({super.key});

  @override
  State<ListSellersWWidget> createState() => _ListSellersWWidgetState();
}

class _ListSellersWWidgetState extends State<ListSellersWWidget> {
  late ListSellersWModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListSellersWModel());
