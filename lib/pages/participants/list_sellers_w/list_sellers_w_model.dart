...
import 'list_sellers_w_widget.dart' show ListSellersWWidget;
...
class ListSellersWModel extends FlutterFlowModel<ListSellersWWidget> {
  ...
  // Stores action output result for [Backend Call - API (People)] action in ListSellersW widget.
  ApiCallResponse? apiResultvxa;
  // Stores action output result for [Custom Action - parseListPeople] action in ListSellersW widget.
