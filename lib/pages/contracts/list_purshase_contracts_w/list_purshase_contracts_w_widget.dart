...
import 'list_purshase_contracts_w_model.dart';
export 'list_purshase_contracts_w_model.dart';

class ListPurshaseContractsWWidget extends StatefulWidget {
  const ListPurshaseContractsWWidget({super.key});

  @override
  State<ListPurshaseContractsWWidget> createState() =>
      _ListPurshaseContractsWWidgetState();
}

class _ListPurshaseContractsWWidgetState
    extends State<ListPurshaseContractsWWidget> {
  late ListPurshaseContractsWModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListPurshaseContractsWModel());
                                                ...
                                                FFButtonWidget(
                                                  onPressed: () async {
                                                    ...
                                                    ScaffoldMessenger.of(
                                                      ...
                                                      SnackBar(
                                                        content: Text(
                                                          'Se recuperaron ${_model.listContractsFiltered.length.toString()} registros',
                                                          style: TextStyle(
                                                            color: FlutterFlowTheme
                                                                    .of(context)
                                                                .primaryText,
