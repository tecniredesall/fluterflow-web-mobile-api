...
import 'bottom_sheet_cities_model.dart';
export 'bottom_sheet_cities_model.dart';

class BottomSheetCitiesWidget extends StatefulWidget {
  const BottomSheetCitiesWidget({
    super.key,
  ...
  @override
  State<BottomSheetCitiesWidget> createState() =>
      _BottomSheetCitiesWidgetState();
}

class _BottomSheetCitiesWidgetState extends State<BottomSheetCitiesWidget> {
  late BottomSheetCitiesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BottomSheetCitiesModel());
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        onChanged: (_) => EasyDebounce.debounce(
                          ...
                          () async {
                            _model.citiesSearchFilter =
                                await actions.searchCitiesInterceptorRequest(
                          ...
                          suffixIcon: _model
                              ...
                              ? InkWell(
                                  onTap: () async {
                                    ...
                                    _model.citiesSearchFilter = await actions
                                        .searchCitiesInterceptorRequest(
                                      _model.textToSearchTextController.text,
                                      widget.countrySlug!,
                                      widget.stateId!,
                                    );
              ...
              child: RefreshIndicator(
                ...
                child: PagedListView<ApiPagingParams, dynamic>(
                  pagingController: _model.setListViewController(
                    (nextPageMarker) => CRMLocationsGroup.citiesCall.call(
                      partitionKey: FFAppState().partitionKey,
                      authToken: currentAuthenticationToken,
                      page: nextPageMarker.nextPageNumber + 1,
                      filter: _model.textToSearchTextController.text != null &&
                              _model.textToSearchTextController.text != ''
                          ? _model.citiesSearchFilter
                          : ((String countrySlug, String stateId) {
                              return "\{\"country_slug\"\:\"" +
                                  countrySlug +
                                  "\",\"state\"\:\"" +
                                  stateId +
                                  "\"\}";
                            }(widget.countrySlug!, widget.stateId!)),
                    ),
                  ),
