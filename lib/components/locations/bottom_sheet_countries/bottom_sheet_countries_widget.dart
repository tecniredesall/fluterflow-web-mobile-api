...
import 'bottom_sheet_countries_model.dart';
export 'bottom_sheet_countries_model.dart';

class BottomSheetCountriesWidget extends StatefulWidget {
  const BottomSheetCountriesWidget({
    super.key,
  ...
  @override
  State<BottomSheetCountriesWidget> createState() =>
      _BottomSheetCountriesWidgetState();
}

class _BottomSheetCountriesWidgetState
    extends State<BottomSheetCountriesWidget> {
  late BottomSheetCountriesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BottomSheetCountriesModel());
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        onChanged: (_) => EasyDebounce.debounce(
                          ...
                          () async {
                            _model.countriesSearchFilter =
                                await actions.searchCountriesInterceptorRequest(
                          ...
                          suffixIcon: _model
                              ...
                              ? InkWell(
                                  onTap: () async {
                                    ...
                                    _model.countriesSearchFilter = await actions
                                        .searchCountriesInterceptorRequest(
                                      _model.textToSearchTextController.text,
                                    );
                                    setState(() => _model
              ...
              child: RefreshIndicator(
                ...
                child: PagedListView<ApiPagingParams, dynamic>(
                  pagingController: _model.setListViewController(
                    (nextPageMarker) => CRMLocationsGroup.countriesCall.call(
