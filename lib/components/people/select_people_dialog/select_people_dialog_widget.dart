...
import 'select_people_dialog_model.dart';
export 'select_people_dialog_model.dart';

class SelectPeopleDialogWidget extends StatefulWidget {
  const SelectPeopleDialogWidget({
    super.key,
    required this.role,
    required this.selectedItemParameter,
  });

  final Role? role;
  final Future Function(dynamic seletedItem)? selectedItemParameter;

  @override
  State<SelectPeopleDialogWidget> createState() =>
      _SelectPeopleDialogWidgetState();
}

class _SelectPeopleDialogWidgetState extends State<SelectPeopleDialogWidget> {
  late SelectPeopleDialogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectPeopleDialogModel());
                  ...
                  itemBuilder: (context, _, peopleRowIndex) {
                    ...
                    return InkWell(
                      ...
                      child: RowListViewPeopleWidget(
                        key: Key(
                            'Keyeml_${peopleRowIndex}_of_${_model.listViewPagingController!.itemList!.length}'),
